...
lines1=`ls -altrh SingleTop1/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop1/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop1: $lines2/$lines1 root files are ready"
fi
lines1=`ls -altrh SingleTop2/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop2/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop2: $lines2/$lines1  root files are ready"
fi
lines1=`ls -altrh SingleTop3/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop3/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop3: $lines2/$lines1  root files are ready"
fi
lines1=`ls -altrh SingleTop4/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop4/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop4: $lines2/$lines1 root files are ready"
fi
lines1=`ls -altrh SingleTop5/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop5/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop5: $lines2/$lines1  root files are ready"
fi
lines1=`ls -altrh SingleTop6/r*sh 2>/dev/null  | wc -l`
lines2=`grep "T---Report end\!" SingleTop6/* -s | wc -l`
if [ "$lines1" -ne "0" ]; then 
    echo "SingleTop6: $lines2/$lines1  root files are ready"
fi
echo ""
