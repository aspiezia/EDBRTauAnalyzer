{
  ...
  PLOT.push_back("dRLep1Lep2");      BIN.push_back(60); MIN.push_back(0);   MAX.push_back(6);   MAXY.push_back(4);   AXIS.push_back("#DeltaR (lep1,lep2)");
  ...
  for(int type=0; type<2; type++){
	...
	if(j==0){ 
	  ...
	  sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL1,lep1PtCut,deltaRCutFL,deltaR);
	}else if(j==1){ 
	  sprintf(openTree, "demo/TreeMuoMuo"); 
	  sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL2,lep1PtCut,deltaRCutFL,deltaR);
	}else if(j==2){ 
	  sprintf(openTree, "demo/TreeEleEle"); 
	  sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL2,lep1PtCut,deltaRCutFL,deltaR);
	}else if(j==3){ 
	  sprintf(openTree, "demo/TreeMuoTau");
	  sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f && dRLep1Lep2<%f)",CUTPre,METCutSL,MassVisCutSL, tauPtCut, deltaRCutSL,deltaR);
	}else if(j==4){ 
	...
	c1->SetLogy();
      ...
      if(save && i==0 && !SL) 
	c1->SaveAs("dRLep1Lep2_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_FL1000.pdf");
      if(save && i==0 && SL)  
	c1->SaveAs("dRLep1Lep2_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_SL1000.pdf");
    }
  }
}
