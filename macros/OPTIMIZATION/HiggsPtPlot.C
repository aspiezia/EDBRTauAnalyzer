{
  ...
  TH1F *Optimization1  = new TH1F("Optimization1", "Optimization1", 62,19,329);
  TH1F *Optimization2  = new TH1F("Optimization2", "Optimization2", 62,19,329);
  TH1F *Optimization3  = new TH1F("Optimization3", "Optimization3", 62,19,329);
  TH1F *Optimization4  = new TH1F("Optimization4", "Optimization4", 62,19,329);
  ...
  for(int type=0; type<2; type++){
	...
	sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL1,lep1PtCut,deltaRCutFL);
      }else if(j==1){ 
	sprintf(openTree, "demo/TreeMuoMuo"); 
	sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL2,lep1PtCut,deltaRCutFL);
      }else if(j==2){ 
	sprintf(openTree, "demo/TreeEleEle"); 
	sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f)",CUTPre,METCutFL,MassVisCutFL2,lep1PtCut,deltaRCutFL);
      }else if(j==3){ 
	sprintf(openTree, "demo/TreeMuoTau");
	sprintf(CUT, "%s && met>%f && MassVis>%f && lep1Pt>%f && dRLep1Lep2<%f)",CUTPre,METCutSL,MassVisCutSL, tauPtCut, deltaRCutSL);
      }else if(j==4){ 
    ...
    if(save && !SL) 
      c1->SaveAs("PtSvfit_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_FL1000.pdf");
    if(save && SL)  
      c1->SaveAs("PtSvfit_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_SL1000.pdf");
  }
}
