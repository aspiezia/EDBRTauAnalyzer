{
  ...
  PLOT.push_back("tauPt");      BIN.push_back(50); MIN.push_back(0);   MAX.push_back(500);   MAXY.push_back(60);   AXIS.push_back("#tau pt [GeV]");
  PLOT.push_back("lepPt");      BIN.push_back(50); MIN.push_back(0);   MAX.push_back(500);   MAXY.push_back(60);   AXIS.push_back("lep pt [GeV]");
  PLOT.push_back("lepPt1");     BIN.push_back(50); MIN.push_back(0);   MAX.push_back(500);   MAXY.push_back(60);   AXIS.push_back("lead lep pt [GeV]");
  PLOT.push_back("lepPt2");     BIN.push_back(50); MIN.push_back(0);   MAX.push_back(500);   MAXY.push_back(60);   AXIS.push_back("sublead lep pt [GeV]");
  
  TH1F *ptLepoptimization1  = new TH1F("ptLepoptimization1","ptLepoptimization1",9,7.5, 52.5);
  TH1F *ptLepoptimization2  = new TH1F("ptLepoptimization2","ptLepoptimization2",9,7.5, 52.5);
  TH1F *SignalEfficiency1 = new TH1F("SignalEfficiency1","SignalEfficiency1",9,7.5, 52.5);
  TH1F *SignalEfficiency2 = new TH1F("SignalEfficiency2","SignalEfficiency2",9,7.5, 52.5);
  TH1F *BackgroundYield1  = new TH1F("BackgroundYield1","BackgroundYield1",9,7.5, 52.5);
  TH1F *BackgroundYield2  = new TH1F("BackgroundYield2","BackgroundYield2",9,7.5, 52.5);
  ...
  for(int PT=0; PT<PLOT.size();PT++){
	...
	for(int j=jMIN; j<jMAX; j++){
	  ...
	  if(k==0){
	    if(j==0){ 
	      ...
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && %s>%f)",plot,ptLep);
	    }else if(j==1){ 
	      sprintf(openTree, "demo/TreeMuoMuo"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && %s>%f && MassVis>10)",plot,ptLep);
	    }else if(j==2){ 
	      sprintf(openTree, "demo/TreeEleEle"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && %s>%f && MassVis>10)",plot,ptLep);
	    }else if(j==3){ 
	      sprintf(openTree, "demo/TreeMuoTau");
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && %s>%f && lepCorrPFIso<0.2)",plot,ptLep);
	    }else if(j==4){ 
	      sprintf(openTree, "demo/TreeEleTau"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && %s>%f && lepCorrPFIso<0.1)",plot,ptLep);
	    }
	  }else{
	    if(j==0){ 
	      sprintf(openTree, "demo/TreeEleMuo"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && %s>%f)",plot,ptLep);
	    }else if(j==1){ 
	      sprintf(openTree, "demo/TreeMuoMuo"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && %s>%f && MassVis>10)",plot,ptLep);
	    }else if(j==2){ 
	      sprintf(openTree, "demo/TreeEleEle"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && %s>%f && MassVis>10)",plot,ptLep);
	    }else if(j==3){ 
	      sprintf(openTree, "demo/TreeMuoTau");
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && %s>%f && lepCorrPFIso<0.2)",plot,ptLep);
	    }else if(j==4){ 
	      sprintf(openTree, "demo/TreeEleTau"); 
	      sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && %s>%f && lepCorrPFIso<0.1)",plot,ptLep);
	    }
	  }
	...
	if(save && i==0 && !SL && k==0) c1->SaveAs(name+"_FL1000.png");
	if(save && i==0 && !SL && k==1) c1->SaveAs(name+"_FL2500.png");
	if(save && i==0 && SL && k==0)  c1->SaveAs(name+"_SL1000.png");
	if(save && i==0 && SL && k==1)  c1->SaveAs(name+"_SL2500.png");
    ...
    ptLepoptimization1->SetMaximum(0.5);
    ...
    ptLepoptimization2->SetMarkerColor(2);
    ptLepoptimization2->SetLineColor(2);
    ptLepoptimization2->Draw("Esame");
  
    TLegend *pl = new TLegend(0.57,0.75,0.89,0.89);
    pl->SetTextSize(0.03); 
    pl->SetFillColor(0);
    TLegendEntry *ple = pl->AddEntry(ptLepoptimization1, "Signal - Mass = 1.0 TeV",  "LP");
    ple = pl->AddEntry(ptLepoptimization2, "Signal - Mass = 2.5 TeV",  "LP");
    pl->Draw();
    if(save && !SL) c1->SaveAs(name+"_OPTIMIZATION_FL.png");
    if(save && SL)  c1->SaveAs(name+"_OPTIMIZATION_SL.png");
    ...
    pl->Draw();
    if(save && !SL) c1->SaveAs(name+"_SignalEfficiency_FL.png");
    if(save && SL)  c1->SaveAs(name+"_SignalEfficiency_SL.png");
    ...
    pl->Draw();
    if(save && !SL) c1->SaveAs(name+"_BackgroundYield_FL.png");
    if(save && SL)  c1->SaveAs(name+"_BackgroundYield_SL.png");
  }
}
