{
  ...
  PLOT.push_back("MassSvfit");     BIN.push_back(30); MIN.push_back(0);   MAX.push_back(300);   MAXY.push_back(60);   AXIS.push_back("SVFit M(lep1,lep2) [GeV]");
  ...
  for(int k=0; k<2; k++){
	...
	if(k==0){
	  if(j==0){ 
	    ...
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && MassSvfit>%f)",mass);
	  }else if(j==1){ 
	    sprintf(openTree, "demo/TreeMuoMuo"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && MassSvfit>%f && MassVis>10)",mass);
	  }else if(j==2){ 
	    sprintf(openTree, "demo/TreeEleEle"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && MassSvfit>%f && MassVis>10)",mass);
	  }else if(j==3){ 
	    sprintf(openTree, "demo/TreeMuoTau");
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && MassSvfit>%f && lepCorrPFIso<0.2)",mass);
	  }else if(j==4){ 
	    sprintf(openTree, "demo/TreeEleTau"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>250 && XMassSVFit<1750 && MassSvfit>%f && lepCorrPFIso<0.1)",mass);
	  }
	}else{
	  if(j==0){ 
	    sprintf(openTree, "demo/TreeEleMuo"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && MassSvfit>%f)",mass);
	  }else if(j==1){ 
	    sprintf(openTree, "demo/TreeMuoMuo"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && MassSvfit>%f && MassVis>10)",mass);
	  }else if(j==2){ 
	    sprintf(openTree, "demo/TreeEleEle"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && MassSvfit>%f && MassVis>10)",mass);
	  }else if(j==3){ 
	    sprintf(openTree, "demo/TreeMuoTau");
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && MassSvfit>%f && lepCorrPFIso<0.2)",mass);
	  }else if(j==4){ 
	    sprintf(openTree, "demo/TreeEleTau"); 
	    sprintf(CUT, "trigger*PUWeight*(sideband==0 && met>100 && XMassSVFit>1750 && XMassSVFit<3250 && MassSvfit>%f && lepCorrPFIso<0.1)",mass);
	  }
	}
	...
	c1->SetLogy();
      ...
      if(save && i==0 && !SL && k==0) c1->SaveAs("mass_FullyleptonChannels_FL1000.png");
      if(save && i==0 && !SL && k==1) c1->SaveAs("mass_FullyleptonChannels_FL2500.png");
      if(save && i==0 && SL && k==0)  c1->SaveAs("mass_FullyleptonChannels_SL1000.png");
      if(save && i==0 && SL && k==1)  c1->SaveAs("mass_FullyleptonChannels_SL2500.png");
  ...
  pl->Draw();
  if(save && !SL) c1->SaveAs("mass_OPTIMIZATION_FL.png");
  if(save && SL)  c1->SaveAs("mass_OPTIMIZATION_SL.png");
  ...
  pl->Draw();
  if(save && !SL) c1->SaveAs("mass_SignalEfficiency_FL.png");
  if(save && SL)  c1->SaveAs("mass_SignalEfficiency_SL.png");
  ...
  pl->Draw();
  if(save && !SL) c1->SaveAs("mass_BackgroundYield_FL.png");
  if(save && SL)  c1->SaveAs("mass_BackgroundYield_SL.png");
}
