{
  ...
  for(int type=0; type<2; type++){
    ...
    if(save && !SL) 
      c1->SaveAs("nbtag_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_FL1000.pdf");
    if(save && SL )  
      c1->SaveAs("nbtag_MET"+met+"_lep1Pt"+lep1pt+"_tauPt"+taupt+"_btag"+btag+"_dR"+drcut+"_massSvfit"+masssvfitcut+"_massVis"+massviscut+"_SL1000.pdf");
  }
}
