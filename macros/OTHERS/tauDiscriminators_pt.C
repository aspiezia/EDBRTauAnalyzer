{
  ...
  //TString discriminant = "iso";      int N = 40*2;
  //TString discriminant = "electron"; int N = 11*2;
  //TString discriminant = "muon";     int N = 12*2;
  //TString discriminant = "final";     int N = 1;
  TString discriminant = "finalOLD";     int N = 1;

  Double_t xbins[9] = {0, 20, 60, 100, 150, 200, 250, 300, 500};

  TCanvas* c1 = new TCanvas("c1","c1",0,0,800,600);

  TFile *file1 = TFile::Open("../RISULTATI/christianCheck_040213/ZH1000_tauMC.root");
  TFile *file2 = TFile::Open("../RISULTATI/christianCheck_040213/ZH2500_tauMC.root");
  TFile *file3 = TFile::Open("../RISULTATI/christianCheck_040213/ZH1000_tauMC.root");
  TFile *file4 = TFile::Open("../RISULTATI/christianCheck_040213/ZH2500_tauMC.root");
  TFile *file5 = TFile::Open("../RISULTATI/christianCheck_040213/QCD1000_tauMC.root"); 
  ...
  for(int i=0; i<N; i++){
	...
	if(discriminant=="final" || discriminant=="finalOLD"){
	  c1->SaveAs(CHANNEL+"_"+discriminant+".png");
	  cout<<i+1<<") Saving "<<CHANNEL<<"_"<<discriminant<<".png"<<endl;
	} else if(discriminant=="decay" || (discriminant=="iso" && i<40) || (discriminant=="electron" && i<11) || (discriminant=="muon" && i<12)) {
	  c1->SaveAs(CHANNEL+"_"+discriminant+"_"+NAME[i]+".png");
	  cout<<i+1<<") Saving "<<CHANNEL<<"_"<<discriminant<<"_"<<NAME[i]<<".png"<<endl;
	} else {
	  c1->SaveAs(CHANNEL+"_"+discriminant+"2_"+NAME[i-N/2]+".png");
	  cout<<i+1<<") Saving "<<CHANNEL<<"_"<<discriminant<<"2_"<<NAME[i-N/2]<<".png"<<endl;
	}
      } else {
	if(discriminant=="final" || discriminant=="finalOLD"){
	  c1->SaveAs("QCD_"+discriminant+".png");
	  cout<<i+1<<") Saving "<<"QCD_"<<discriminant<<".png"<<endl;
	} else if(discriminant=="decay" || (discriminant=="iso" && i<40) || (discriminant=="electron" && i<11) || (discriminant=="muon" && i<12)) {
	  c1->SaveAs("QCD_"+discriminant+"_"+NAME[i]+".png");
	  cout<<i+1<<") Saving "<<"QCD_"<<discriminant<<"_"<<NAME[i]<<".png"<<endl;
	} else {
	  c1->SaveAs("QCD_"+discriminant+"2_"+NAME[i-N/2]+".png");
	  cout<<i+1<<") Saving "<<"QCD_"<<discriminant<<"2_"<<NAME[i-N/2]<<".png"<<endl;
	}
      }
    }
  }
