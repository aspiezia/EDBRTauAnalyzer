...
void BreitWigner(char *channel, RooWorkspace *w, RooPlot* frame, RooRealVar XMassSVFit, float MAX, float XMassBin, TH1F *histo_PRE,
  ...
  const int N = 12; 
  Double_t xbins[N] = {0,300,600,800,1000,1200,1400,1600,1900,2200,2500,3000};
  RooBinning glbins(N-1, xbins, "glbin");
  XMassSVFit.setBinning(glbins);
  ...
  dataset.plotOn(frame,RooFit::Name("dataset"),RooFit::Binning(glbins),RooFit::LineColor(2),RooFit::MarkerColor(2),RooFit::LineWidth(2));  
