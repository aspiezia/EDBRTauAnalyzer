void BKGPrediction_3(){
  ...
  float XMassWidth=200; float XMassBin=15; float XMassMin=0; float XMassMax=XMassWidth; float MAX = XMassWidth*XMassBin;bool save=false;
  ...
  for(int i=0; i<1; i++){
    ...
    TH1F *histo_DAT1 = new TH1F("histo_DAT1","histo_DAT1",XMassBin,0,MAX); 
    ...
    TH1F *histo_DAT2 = new TH1F("histo_DAT2","histo_DAT2",XMassBin,0,MAX); 
    ...
    TH1F *histo_DAT3 = new TH1F("histo_DAT3","histo_DAT3",XMassBin,0,MAX); 
    ...
    TH1F *histo_DAT4 = new TH1F("histo_DAT4","histo_DAT4",XMassBin,0,MAX); 
    ...
    TH1F *histo_DAT5 = new TH1F("histo_DAT5","histo_DAT5",XMassBin,0,MAX); 
