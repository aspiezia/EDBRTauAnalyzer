{
  ...
  int N = 12;
  Double_t xbins[N] = {10,20,40,60,80,100,150,200,250,300,400,500};
  ...
  if(i==0){
    ...
    NAME.push_back("recoLep1EcalDriven");
    NAME.push_back("recoLep1dPhiInHEEP");
    NAME.push_back("recoLep1HoverEHEEP");
    NAME.push_back("recoLep1TkSumPt");
    NAME.push_back("recoLep1LostHits");
    NAME.push_back("recoLep1dEtaInHEEP");
    NAME.push_back("recoLep1dxyHEEP");
    NAME.push_back("recoLep1e5xe5");
    NAME.push_back("recoLep1SigmaIEIEHEEP");
    //MUO
    ...
    NAME.push_back("recoLep2EcalDriven");
    NAME.push_back("recoLep2dPhiInHEEP");
    NAME.push_back("recoLep2HoverEHEEP");
    NAME.push_back("recoLep2TkSumPt");
    NAME.push_back("recoLep2LostHits");
    NAME.push_back("recoLep2dEtaInHEEP");
    NAME.push_back("recoLep2dxyHEEP");
    NAME.push_back("recoLep2e5xe5");
    NAME.push_back("recoLep2SigmaIEIEHEEP");
  } else if(i==3){
    //TAU
  ...
  for(int j=0; j<NAME.size(); j++){
    ...
    if(NAME[j].Contains("Lep1")){
      char variable1[500]; sprintf(variable1, "recoLep1PtF>>h1(4000,0,2500)"); Tree1->Draw(variable1, input2, "E");
      char variable2[500]; sprintf(variable2, "recoLep1PtF>>h2(4000,0,2500)"); Tree2->Draw(variable2, input2, "Esame");
      char variable3[500]; sprintf(variable3, "recoLep1PtF>>h3(4000,0,2500)"); Tree3->Draw(variable3, input2, "Esame");
      char variable4[500]; sprintf(variable4, "recoLep1PtF>>h4(4000,0,2500)"); Tree4->Draw(variable4, input2, "Esame");
      char variable5[500]; sprintf(variable5, "recoLep1PtF>>h5(4000,0,2500)"); Tree1->Draw(variable5, input1, "Esame");
      char variable6[500]; sprintf(variable6, "recoLep1PtF>>h6(4000,0,2500)"); Tree2->Draw(variable6, input1, "Esame");
      char variable7[500]; sprintf(variable7, "recoLep1PtF>>h7(4000,0,2500)"); Tree3->Draw(variable7, input1, "Esame");
      char variable8[500]; sprintf(variable8, "recoLep1PtF>>h8(4000,0,2500)"); Tree4->Draw(variable8, input1, "Esame");
    } else if(NAME[j].Contains("Lep2")){
      char variable1[500]; sprintf(variable1, "recoLep2PtF>>h1(4000,0,2500)"); Tree1->Draw(variable1, input2, "E");
      char variable2[500]; sprintf(variable2, "recoLep2PtF>>h2(4000,0,2500)"); Tree2->Draw(variable2, input2, "Esame");
      char variable3[500]; sprintf(variable3, "recoLep2PtF>>h3(4000,0,2500)"); Tree3->Draw(variable3, input2, "Esame");
      char variable4[500]; sprintf(variable4, "recoLep2PtF>>h4(4000,0,2500)"); Tree4->Draw(variable4, input2, "Esame");
      char variable5[500]; sprintf(variable5, "recoLep2PtF>>h5(4000,0,2500)"); Tree1->Draw(variable5, input1, "Esame");
      char variable6[500]; sprintf(variable6, "recoLep2PtF>>h6(4000,0,2500)"); Tree2->Draw(variable6, input1, "Esame");
      char variable7[500]; sprintf(variable7, "recoLep2PtF>>h7(4000,0,2500)"); Tree3->Draw(variable7, input1, "Esame");
      char variable8[500]; sprintf(variable8, "recoLep2PtF>>h8(4000,0,2500)"); Tree4->Draw(variable8, input1, "Esame");
    }
    ...
    hnew1->GetXaxis()->SetRangeUser(xbins[0],xbins[N-1]);
    if((CHANNEL=="MuoTau" || CHANNEL=="EleTau") && (NAME[j].Contains("Lep1"))) hnew1->GetXaxis()->SetRangeUser(xbins[1],xbins[N-1]);
    hnew1->GetXaxis()->SetTitle("reco lepton pt [GeV]");
    ...
    c1->SaveAs("Eff_"+CHANNEL+"_"+NAME[j]+".pdf");
    cout<<"Eff_"<<CHANNEL<<"_"<<NAME[j]<<".pdf"<<endl;
  }
}
