{
  ...
  int N = 13;
  Double_t xbins[N] = {-2.8,-2.5,-2.0,-1.5,-1.0,-0.5,0.0,0.5,1.0,1.5,2.0,2.5,2.8};
  ...
  for(int j=0; j<NAME.size(); j++){
    ...
    if(NAME[j].Contains("Lep1")){
      char variable1[500]; sprintf(variable1, "recoLep1EtaF>>h1(4000,-2.8,2.8)"); Tree1->Draw(variable1, input2, "E");
      char variable2[500]; sprintf(variable2, "recoLep1EtaF>>h2(4000,-2.8,2.8)"); Tree2->Draw(variable2, input2, "Esame");
      char variable3[500]; sprintf(variable3, "recoLep1EtaF>>h3(4000,-2.8,2.8)"); Tree3->Draw(variable3, input2, "Esame");
      char variable4[500]; sprintf(variable4, "recoLep1EtaF>>h4(4000,-2.8,2.8)"); Tree4->Draw(variable4, input2, "Esame");
      char variable5[500]; sprintf(variable5, "recoLep1EtaF>>h5(4000,-2.8,2.8)"); Tree1->Draw(variable5, input1, "Esame");
      char variable6[500]; sprintf(variable6, "recoLep1EtaF>>h6(4000,-2.8,2.8)"); Tree2->Draw(variable6, input1, "Esame");
      char variable7[500]; sprintf(variable7, "recoLep1EtaF>>h7(4000,-2.8,2.8)"); Tree3->Draw(variable7, input1, "Esame");
      char variable8[500]; sprintf(variable8, "recoLep1EtaF>>h8(4000,-2.8,2.8)"); Tree4->Draw(variable8, input1, "Esame");
    } else if(NAME[j].Contains("Lep2")){
      char variable1[500]; sprintf(variable1, "recoLep2EtaF>>h1(4000,-2.8,2.8)"); Tree1->Draw(variable1, input2, "E");
      char variable2[500]; sprintf(variable2, "recoLep2EtaF>>h2(4000,-2.8,2.8)"); Tree2->Draw(variable2, input2, "Esame");
      char variable3[500]; sprintf(variable3, "recoLep2EtaF>>h3(4000,-2.8,2.8)"); Tree3->Draw(variable3, input2, "Esame");
      char variable4[500]; sprintf(variable4, "recoLep2EtaF>>h4(4000,-2.8,2.8)"); Tree4->Draw(variable4, input2, "Esame");
      char variable5[500]; sprintf(variable5, "recoLep2EtaF>>h5(4000,-2.8,2.8)"); Tree1->Draw(variable5, input1, "Esame");
      char variable6[500]; sprintf(variable6, "recoLep2EtaF>>h6(4000,-2.8,2.8)"); Tree2->Draw(variable6, input1, "Esame");
      char variable7[500]; sprintf(variable7, "recoLep2EtaF>>h7(4000,-2.8,2.8)"); Tree3->Draw(variable7, input1, "Esame");
      char variable8[500]; sprintf(variable8, "recoLep2EtaF>>h8(4000,-2.8,2.8)"); Tree4->Draw(variable8, input1, "Esame");
    }
    ...
    hnew1->GetXaxis()->SetRangeUser(-2.8,2.8);
    hnew1->GetXaxis()->SetTitle("reco lepton eta");
    ...
    c1->SaveAs("Eff_eta_"+CHANNEL+"_"+NAME[j]+".pdf");
    cout<<"Eff_eta_"<<CHANNEL<<"_"<<NAME[j]<<".pdf"<<endl;
  }
}
