...
void limit(bool only_leptonTAG=false, bool save_plots = false, float min=0.006, float max=900., TString plot_name="Limit_prova.pdf") {
  ...
  c1->SetLogy();
  save_plots = true;
  plot_name="limit_FullyLep.png";

  Double_t XMass[val]    = {1000, 1500, 2000, 2500};
	
  //LIMIT - Breit-Wigner
  Double_t Limit_Obs[val]     = {0,0,0,0};
  Double_t Limit_Exp_m2s[val] = {5.7635 , 13.6639, 64.1197 , 174.7513};
  Double_t Limit_Exp_m1s[val] = {7.8737 , 19.2556, 92.2869 , 253.1163};
  Double_t Limit_Exp[val]     = {11.5723, 29.3945, 143.3594, 397.6562};
  Double_t Limit_Exp_p1s[val] = {17.3382, 47.9071, 231.3606, 641.7578};
  Double_t Limit_Exp_p2s[val] = {24.6601, 78.0430, 364.0143, 1000.851};

  //LIMIT - GaussXLandau
  Double_t Limit_Obs2[val]     = {0,0,0,0};
  Double_t Limit_Exp_m2s2[val] = {5.2529 , 16.5707, 73.7289 , 194.1284};
  Double_t Limit_Exp_m1s2[val] = {7.2563 , 23.1425, 105.4056, 280.0840};
  Double_t Limit_Exp2[val]     = {10.8887, 35.0586, 164.8438, 435.9375};
  Double_t Limit_Exp_p1s2[val] = {16.5744, 56.0204, 268.6615, 703.5380};
  Double_t Limit_Exp_p2s2[val] = {23.8737, 87.2425, 430.3941, 1087.480};
